...
Learning Repository}. The dataset was donated by Ron Kohavi and Barry
...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} Import libraries necessary for this project}
        ...
        \PY{n}{display}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{n}{n}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} TODO: Total number of records}
        \PY{n}{n\PYZus{}records} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{income}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} TODO: Number of records where individual\PYZsq{}s income is more than \PYZdl{}50,000}
        \PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{count\PYZus{}nonzero}\PY{p}{(}\PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{income}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZgt{}50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} TODO: Number of records where individual\PYZsq{}s income is at most \PYZdl{}50,000}
        \PY{n}{n\PYZus{}at\PYZus{}most\PYZus{}50k} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{count\PYZus{}nonzero}\PY{p}{(}\PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{income}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZlt{}=50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} TODO: Percentage of individuals whose income is more than \PYZdl{}50,000}
        \PY{n}{greater\PYZus{}percent} \PY{o}{=} \PY{p}{(}\PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{/} \PY{n}{n\PYZus{}records}\PY{p}{)} \PY{o}{*} \PY{l+m+mf}{100.00}
...
records with ``\textgreater{}50K'' to \texttt{1}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} TODO: One\PYZhy{}hot encode the \PYZsq{}features\PYZus{}log\PYZus{}minmax\PYZus{}transform\PYZsq{} data using pandas.get\PYZus{}dummies()}
         ...
         \PY{c+c1}{\PYZsh{}print(features\PYZus{}final)}
         
         \PY{c+c1}{\PYZsh{} TODO: Encode the \PYZsq{}income\PYZus{}raw\PYZsq{} data to numerical values}
         \PY{n}{income} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{get\PYZus{}dummies}\PY{p}{(}\PY{n}{income\PYZus{}raw}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZgt{}50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{c+c1}{\PYZsh{}print(income)}
...
Run the code cell below to perform this split.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Import train\PYZus{}test\PYZus{}split}
...
classification), in other words it is the ratio of
...
are dealing with ratios).
    ...
    \hypertarget{question-1---naive-predictor-performance}{%
\subsubsection{Question 1 - Naive Predictor
Performance}\label{question-1---naive-predictor-performance}}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{TP} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{income}\PY{p}{)} \PY{c+c1}{\PYZsh{} Counting the ones as this is the naive case. Note that \PYZsq{}income\PYZsq{} is the \PYZsq{}income\PYZus{}raw\PYZsq{} data }
         ...
         \PY{n}{accuracy} \PY{o}{=} \PY{n}{TP} \PY{o}{/} \PY{p}{(}\PY{n}{TP} \PY{o}{+} \PY{n}{FP}\PY{p}{)}
         ...
         \PY{n}{fscore} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1} \PY{o}{+} \PY{l+m+mf}{0.5}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{p}{(}\PY{n}{precision} \PY{o}{*} \PY{n}{recall}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{p}{(}\PY{l+m+mf}{0.5}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{*} \PY{n}{precision}\PY{p}{)} \PY{o}{+} \PY{n}{recall}\PY{p}{)}\PY{p}{)}
